...
public class MainWindow extends JFrame implements ActionListener, WindowListener, IRLbotCreationListener
{
    /**
     *
     */
    ...
    public void irlbotCreated()
    {
        ...
        this.tabbedPane
                .addTab("URLseen", new URLseenTab(Manager.getInstance().getIRLbot().getNumberOfURLseenBuckets()));
        ...
        this.tabbedPane.addTab("RobotsCache",
                               new RobotsCacheTab(Manager.getInstance().getIRLbot().getNumberOfRobotsCacheBuckets()));
        this.tabbedPane.addTab("RobotsRequested", new RobotsRequestedTab(
                Manager.getInstance().getIRLbot().getNumberOfRobotsRequestedBuckets()));
    }
