                ...
                switch (stateUpdate.getState())
                {
                    ...
                    case WAITING_FOR_LOCK:
                        ...
                        this.statusBarMainMergerLabel.setText(
                                "Main-Thread merger: Waiting on Lock of bucket writer " + stateUpdate.getBucketId());
                        break;
                    case MERGING:
                        this.mainMerger.setBackground(Color.GREEN);
                        this.mainMerger.setText(
                                "Merging content of bucket file " + stateUpdate.getBucketId() + " into disk storage");
                        this.statusBarMainMergerLabel.setText(
                                "Main-Thread merger: Merging content of bucket file " + stateUpdate.getBucketId() +
                                " into disk storage");
                        break;
                    case FINISHED:
                ...
                switch (stateUpdate.getState())
                {
                    ...
                    case WAITING_FOR_LOCK:
                        ...
                        this.statusBarMergerLabel.setText(
                                "Merger thread: Waiting on Lock of bucket writer " + stateUpdate.getBucketId());
                        break;
                    case MERGING:
                        this.merger.setBackground(Color.GREEN);
                        this.merger.setText(
                                "Merging content of bucket file " + stateUpdate.getBucketId() + " into disk storage");
                        this.statusBarMergerLabel
                                .setText("Merger thread: Merging content of bucket file " + stateUpdate.getBucketId() +
                                         " into disk storage");
                        break;
                    case FINISHED:
