...
public class ConfigurationTab extends JPanel implements ActionListener, KeyListener
{
    ...
    private final JTextField numCrawlingThreads = new JTextField("10", 8); //"100", 8);
    private final JTextField numRobotsDownloaderThreads = new JTextField("5", 8); //"10", 8);
    private final JTextField numUrlSeenBuckets = new JTextField("64", 8); // "512", 8);
    private final JTextField numUrlSeenByteSize = new JTextField("512", 8); //"1024", 8);
    private final JTextField numPldIndegreeBuckets = new JTextField("8", 8); // "16", 8);
    private final JTextField numPldIndegreeByteSize = new JTextField("128", 8); //"64", 8);
    private final JTextField numRobotsCacheBuckets = new JTextField("8", 8); //"16", 8);
    private final JTextField numRobotsCacheByteSize = new JTextField("256", 8);
    private final JTextField numRobotsRequestedBuckets = new JTextField("8", 8); //"16", 8);
    ...
    private void addLine(JPanel parent, JLabel label, JTextField text, JLabel label2, JTextField text2,
        ...
        switch (command)
        {
            ...
            case "start":
            {
                ...
                try
                {
                    ...
                    Manager.getInstance()
                            .createCrawler(urls, crawlingThreads, robotsDownloader, urlSeenBuckets, urlSeenByteSize,
                                           pldBuckets, pldByteSize, robotsCacheBuckets, robotsCacheByteSize,
                                           robotsRequestedBuckets, robotsRequestedByteSize);
