...
/**
 * Compares two {@link PLDData} instances by their budget and ranks the object with the greater budget before the object
 * with less budget. This will sort the {@link PLDData} objects in reverse order by their budget listing the object with
 * the largest budget before objects with less budget.
 *
 * @param <T>
 *         The type of the data to compare
 */
